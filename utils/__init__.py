...
def protocol_decoder(protocol):
    if protocol == "O_C_I_to_M":
        ...
        data_name_list_test = ["MSU_MFSD"]
    elif protocol == "O_I_to_M":
        data_name_list_train = ["OULU", "Replay_attack"]
        data_name_list_test = ["MSU_MFSD"]
    elif protocol == "C_I_to_M":
        data_name_list_train = ["CASIA_MFSD", "Replay_attack"]
        data_name_list_test = ["MSU_MFSD"]
    ...
    elif protocol == "O_M_to_C":
        data_name_list_train = ["OULU", "MSU_MFSD"]
        data_name_list_test = ["CASIA_MFSD"]
    elif protocol == "O_I_to_C":
        data_name_list_train = ["OULU", "Replay_attack"]
        data_name_list_test = ["CASIA_MFSD"]
    elif protocol == "I_to_C":
        data_name_list_train = ["Replay_attack"]
        data_name_list_test = ["CASIA_MFSD"]
    elif protocol == "M_I_to_C":
        data_name_list_train = ["MSU_MFSD", "Replay_attack"]
        data_name_list_test = ["CASIA_MFSD"]
    elif protocol == "O_C_to_I":
        data_name_list_train = ["OULU", "CASIA_MFSD"]
        data_name_list_test = ["Replay_attack"]
    elif protocol == "C_to_I":
        data_name_list_train = ["CASIA_MFSD"]
        data_name_list_test = ["Replay_attack"]
    elif protocol == "O_M_to_I":
        data_name_list_train = ["OULU","MSU_MFSD"]
        data_name_list_test = ["Replay_attack"]
    elif protocol == "C_M_to_I":
        data_name_list_train = ["CASIA_MFSD", "MSU_MFSD"]
        data_name_list_test = ["Replay_attack"]
    elif protocol == "O_C_M_to_I":
        data_name_list_train = ["OULU", "CASIA_MFSD", "MSU_MFSD"]
        data_name_list_test = ["Replay_attack"]
    elif protocol == "I_C_M_to_O":
        data_name_list_train = ["Replay_attack", "CASIA_MFSD","MSU_MFSD"]
        data_name_list_test = ["OULU"]
    elif protocol == "I_C_to_O":
        data_name_list_train = ["Replay_attack","CASIA_MFSD"]
        data_name_list_test = ["OULU"]
    elif protocol == "I_M_to_O":
        data_name_list_train = ["Replay_attack","MSU_MFSD"]
        data_name_list_test = ["OULU"]
    elif protocol == "C_M_to_O":
        data_name_list_train = ["CASIA_MFSD","MSU_MFSD"]
        data_name_list_test = ["OULU"]
    elif protocol == "I_C_M_O":
        data_name_list_train =  ["OULU", "MSU_MFSD", "Replay_attack", "CASIA_MFSD"]
        data_name_list_test = [" "]    
